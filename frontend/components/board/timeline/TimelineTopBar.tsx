...
interface TimelineTopBarProps {
  taskCount: number;
  rangeDays: 21 | 30 | 60;
  onRangeDaysChange: (value: 21 | 30 | 60) => void;
}

const TimelineTopBar: React.FC<TimelineTopBarProps> = ({ taskCount, rangeDays, onRangeDaysChange }) => {
  return (
    <div className="border-b border-slate-200 px-3 py-2 flex items-center justify-between gap-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <select
          ...
          value={rangeDays}
          onChange={(event) => onRangeDaysChange(Number(event.target.value) as 21 | 30 | 60)}
        >
