...
const DueDateRangeControl: React.FC<DueDateRangeControlProps> = ({ dueFrom, dueTo, onDueFromChange, onDueToChange }) => {
  return (
    <div className="w-full max-w-full min-w-0 h-10 md:h-8 rounded-lg md:rounded-md border border-slate-200 bg-white px-2 md:px-2.5 flex items-center gap-1 overflow-hidden">
      ...
      <DateInputField
        ...
        compact
        className="w-[92px] min-w-[92px] max-w-[110px] border-0"
      />
